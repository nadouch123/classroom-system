document.addEventListener('DOMContentLoaded', () => {
    ...
    /**
     * 🇫🇷🇪 CUSTOM FRENCH PDF PARSER 🇫🇷🇪
     * This function is designed to parse the specific French format provided by the user.
     * It looks for lines that start with a day of the week.
     * It then parses the time slot and subject.
     */
    function parseScheduleText(text) {
        ...
        lines.forEach(line => {
            daysOfWeek.forEach(day => {
                ...
                // It is flexible and handles extra spaces
                const match = line.match(new RegExp(`(${day})\\s+([\\d:]+-[\\d:]+):\\s*(.+)`, 'i'));
                if (match) {
